...
var ques1sco=0;
var ques=['1. Shortcut of Copy ?','ctrl+s','ctrl+x','ctrl+c','ctrl+v','c'];
var question=ques[0];
var opt1=ques[1]; 
var opt2=ques[2];
var opt3=ques[3];
...
div1.innerHTML='<h3>'+question+'</h3>';
 div1.innerHTML+='<div class="fstrad"><label><input type="radio" value="'+opt1+'" name="radio"  class="radbtn">'+opt1+'</label></div>';
 div1.innerHTML+='<div class="fstrad"><label><input type="radio" value="'+opt2+'" name="radio" class="radbtn">'+opt2+'</label></div>';
div1.innerHTML+='<div class="fstrad"><label><input type="radio" value="'+answer+'" name="radio" id="ans" class="radbtn">'+opt3+'</label></div>';
div1.innerHTML+='<div class="fstrad"><label><input type="radio" value="'+opt4+'" name="radio" class="radbtn">'+opt4+'</label></div>';
...
ques=['2. Choose the Fruits ?','Apple','Raddish','Banana','Beans'];
question2=ques[0];
opt_1=ques[1];
opt_2=ques[2];
opt_3=ques[3];
...
div3.innerHTML='<h3>3.What is the value of 10+30?</h3>';
...
list.innerHTML+='<option value="40" label="40" name="range">40</option>';
list.innerHTML+='<option value="60" label="60" name="range">60</option>';
list.innerHTML+='<option value="80" label="80" name="range">80</option>';
...
div4.innerHTML='<label><h3>4.Expanation for AIR <br><input type="text" id="textbox"></h3></label>';
...
var fourthques=document.getElementById('fournxt');
    ...
    fourthques.addEventListener('click',()=>{
        if(inputans.value=='All India Radio' || inputans.value=='all india radio'){
            ques4sco=1;
