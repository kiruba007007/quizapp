...
var ques1sco=0;
var ques=['1. Which is not a framework?','JavaScript.NET','JavaScript','Cocoa JS','jQuery','b'];
var question=ques[0];
var opt1=ques[1]; 
var opt2=ques[2];
var opt3=ques[3];
...
div1.innerHTML='<h3>'+question+'</h3>';
 div1.innerHTML+='<div class="fstrad rad1"><label><input type="radio" value="'+opt1+'" name="radio"  class="radbtn">'+opt1+'</label></div>';
 div1.innerHTML+='<div class="fstrad rad2"><label><input type="radio" value="'+answer+'" name="radio" class="radbtn" id="ans">'+opt2+'</label></div>';
div1.innerHTML+='<div class="fstrad rad3"><label><input type="radio" value="'+opt3+'" name="radio"  class="radbtn">'+opt3+'</label></div>';
div1.innerHTML+='<div class="fstrad rad4"><label><input type="radio" value="'+opt4+'" name="radio" class="radbtn">'+opt4+'</label></div>';
...
ques=['2. which is these are fruits ?','Apple','Raddish','Banana','Beans'];
question2=ques[0];
opt_1=ques[1];
opt_2=ques[2];
opt_3=ques[3];
...
div2.innerHTML+='<div class="check"><label><input type="checkbox" value="'+opt_1+'" name="checkbox" id="one">'+opt_1+'</label></div>';
div2.innerHTML+='<div class="check"><label><input type="checkbox" value="'+opt_2+'" name="checkbox" id="two">'+opt_2+'</label></div>';
div2.innerHTML+='<div class="check"><label><input type="checkbox" value="'+opt_3+'" name="checkbox" id="three">'+opt_3+'</label></div>';
div2.innerHTML+='<div class="check"><label><input type="checkbox" value="'+opt_4+'" name="checkbox" id="four">'+opt_4+'</label></div>';
...
div3.innerHTML='<h3 class="data3">3.Which one is an Ternary Operator:</h3>';
div3.innerHTML+='<input type="range" list="tickmarks" step="20" max="80"  id="selector"value="0">';
div3.innerHTML+='<datalist id="tickmarks" class="tick"></datalist><br>';
list=document.getElementById('tickmarks');
list.innerHTML='<option value="0" label="!"  name="range">0</option>';
list.innerHTML+='<option value="20" label="?" name="range">20</option>';
list.innerHTML+='<option value="40" label=":" name="range">40</option>';
list.innerHTML+='<option value="60" label="-" name="range">60</option>';
list.innerHTML+='<option value="80" label="+" name="range">80</option>';
...
div4.innerHTML='<label><h3>4.JavaScript language is ?<br><input type="text" id="textbox"></h3></label>';
...
var fourthques=document.getElementById('fournxt');
    ...
    fourthques.addEventListener('click',()=>{
        if(inputans.value=='Object Based' || inputans.value=='object based'){
            ques4sco=1;
